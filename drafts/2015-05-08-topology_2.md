...
In [part 1][part-1] I attempted to briefly motivate the study of topological spaces, and then starting plowing into mass of definitions and propositions that you need to understand this topic in-depth. That latter effort is continued in this post.
